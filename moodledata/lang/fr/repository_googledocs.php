...
$string['oauth2upgrade_message_content'] = 'Le plugin de dépôt Google Docs a été désactivé durant la mise à jour à Moodle 2.3. Pour le réactiver, votre site doit être enregistré auprès de Google, comme décrit dans la documentation {$a->docsurl}, afin d\'obtenir un ID client et un secret. L\'ID client et le secret pourront alors être utilisé pour configurer tous les plugins Google Docs et Picasa.';
...
$string['oauth2upgrade_message_subject'] = 'Information importante sur le plugin de dépôt Google Docs';
