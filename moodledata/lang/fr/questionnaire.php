...
$string['downloadtextformat_help'] = 'Si vous avez besoin de traiter les réponses à un questionnaire en dehors de Moodle dans un logiciel comme Excel, le tableur Calc d\'Open Office ou un logiciel de statistiques, vous pouvez exporter les données au format texte.';
