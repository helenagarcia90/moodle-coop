...
$string['apiv1migration_message_content'] = 'Au cours de la mise à jour à Moodle 2.6, 2.5.3 ou 2.4.7, le plugin de dépôt Box.net a été désactivé. Pour le réactiver, veuillez le reconfigurer suivant la procédure décrite dans la documentation {$a->docsurl}.';
...
$string['information'] = 'Obtenir un ID client et un secret pour votre Moodle sur la <a href="http://www.box.net/developers/services">page développeur de Box.net</a>.';
