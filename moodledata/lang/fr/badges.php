...
$string['attachment_help'] = 'Si ce réglage est activé, le badge décerné sera joint à un message par courriel pour téléchargement. Ce réglage requiert l\'activation des annexes de courriel au niveau du site.';
...
$string['criteria_6_help'] = 'Permet de décerner un badge à des utilisateurs qui ont renseigné certains champs de leur profil. Il est possible de sélectionner parmi les champs par défaut ou personnalisé disponibles.';
...
$string['noparamstoadd'] = 'Il n\'y a pas de paramètre additionnel à ajouter à cette condition de badge.';
