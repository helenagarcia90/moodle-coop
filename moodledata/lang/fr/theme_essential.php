...
$string['right'] = 'Droite';
$string['sideregionsmaxwidth'] = 'Utiliser la largeur maximum pour les zones latérales';
$string['sideregionsmaxwidthdesc'] = 'Ce thème utilise une mise en page fluide. Avec de grands écrans, les zones latérales contenant des blocs peuvent devenir plus larges que nécessaire. Vérifiez ceci pour limiter la largeur de ces zones.';
