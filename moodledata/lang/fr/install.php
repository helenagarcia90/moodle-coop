...
$string['nativemariadbhelp'] = 'Vous devez maintenant configurer la base de données où seront stockées les données de Moodle. Cette base de données peut être créée par l\'installeur automatique de Moodle si l\'utilisateur de la base de données a les droits d\'accès requis. Le nom d\'utilisateur et le mot de passe doivent être définis auparavant. Le préfixe des tables est optionnel.
Ce pilote de base de données n\'est pas compatible avec le moteur MyISAM.';
