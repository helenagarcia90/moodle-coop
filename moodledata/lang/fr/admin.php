...
$string['configpasswordresettime'] = 'Ce réglage spécifie la temps à disposition des utilisateurs pour valider une demande de réinitialisation de mot de passe avant son échéance.
...
$string['configsitemaxcategorydepthhelp'] = 'Ce réglage détermine le nombre maximal de niveaux de catégories filles affichés dans les listes de catégories ou listes combinées. Les niveaux de catégories plus profonds apparaîtront sous forme de liens et pourront être développés par l\'utilisateur.';
...
$string['fullnamedisplayprivate'] = 'Format complet – privé';
...
$string['navshowfullcoursenames_help'] = 'Si ce réglage est activé, les noms complets des cours seront affichés dans la navigation, au lieu des noms abrégés.';
...
$string['opcacherecommended'] = 'La mise en cache PHP opcode améliore les performance et diminue les besoins en mémoire. L\'extension OPcache de PHP est recommandée et totalement supportée.';
...
$string['profilingimportprefix_desc'] = 'Pour faciliter la détection, toutes les exécutions de profilage importées seront préfixées avec le contenu indiqué ici.';
...
$string['thirdpartylibs'] = 'Bibliothèques tierces parties';
