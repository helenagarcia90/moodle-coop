...
/**
 * Strings for component 'block_course_creation', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   block_course_creation
...
$string['course_creation:addinstance'] = 'Add a new courses block';
$string['course_creation:myaddinstance'] = 'Add a new courses block to My home';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = 'Create Courses';
