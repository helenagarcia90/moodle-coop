...
class block_course_creation extends block_list {
    function init() {
        $this->title = get_string('pluginname', 'block_course_creation');
    }
    ...
    function get_content() {
        ...
        $adminseesall = true;
        if (isset($CFG->block_course_creation_adminview)) {
           if ( $CFG->block_course_creation_adminview == 'own'){
               $adminseesall = false;
           }
        }
        ...
        if (empty($CFG->disablemycourses) and isloggedin() and !isguestuser() and
          !(has_capability('moodle/course:update', context_system::instance()) and $adminseesall)) {    // Just print My Courses
            ...
            /// If we can update any course of the view all isn't hidden, show the view all courses link
                if (has_capability('moodle/course:update', context_system::instance()) || empty($CFG->block_course_creation_hideallcourseslink)) {
